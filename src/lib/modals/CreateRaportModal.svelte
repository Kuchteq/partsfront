...
<UniModal {modalName} theme="createRaports" {actionButton} {resetAction} tabName="Stwórz raport">
	<h2>
		Okres raportu:
		<h2>
			<div class="spanButtons">
				...
				<label for="do"><span>Do:</span><input bind:value={dateTo} name="do" type="date" /> </label>
			</div>
		</h2>
	</h2></UniModal
>
