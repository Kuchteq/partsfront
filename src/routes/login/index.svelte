<script>
	import LoginInput from '$shared/loginInput/LoginField.svelte';
...
<header class="absCenter">
	...
	<form on:submit|preventDefault={loginSubmit}>
		<LoginInput placeholderText={'login'} Icon={AccountCircle} bind:value={usernameCred} />
		<LoginInput placeholderText={'hasło'} Icon={PassCircle} bind:value={passCred} type="pass" />
