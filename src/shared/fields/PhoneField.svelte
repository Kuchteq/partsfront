...
>
  <label>{label($_)}</label>
  <input
    on:input={(e) => handleInput("num", e.target.value)}
    value={initValue.number}
    type="tel"
  />
  <select
  ...
  >
    ...
    <option data-countryCode="UA" value="380">Ukraina (+380)</option>
    <option data-countryCode="CZ" value="42">Czechy (+42)</option>
    <optgroup label="Inne Państwa">
